...
class Preprocessor:
    """
    Используя luigi читает данные из таблицы сырых данных, преобразовывает их и
    перекладывает в таблицу обработанных
    """
    ...
    def process(self, ):
        """
        Вызывается для каждого источника данных, проверяет в
        таблице сырых данных новости, которые еще не обработаны,
        делает их преобразование и записывает в таблицу преобразованных
        данных
        """
        pass
